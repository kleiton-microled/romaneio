...
Begin VB.Form Senha_E 
   ...
   Begin VB.PictureBox pQUADRO 
      ...
      Begin VB.ListBox List1 
         ...
         EndProperty
         Height          =   585
         ItemData        =   "frmAcessoG.frx":210C
         Left            =   3000
         List            =   "frmAcessoG.frx":210E
         TabIndex        =   3
         Top             =   1890
         Visible         =   0   'False
         Width           =   1335
  ...
  ' MsgBox Sql
   ...
   If Not tbSenha.EOF Then
        ...
        Else
            ...
            Col_Patio = Nnull(db.Execute("SELECT PATIO_COLETOR FROM OPERADOR..TB_CAD_USUARIOS WHERE USUARIO='" & txtFields(0).text & "'")(0), 0)
            ...
            If Not Tbpatio.EOF Then
               ...
               Do
                 If Col_Patio = 0 Then Col_Patio = Tbpatio!AUTONUM
            ...
            Col_Tam_Pos_Yard = db.Execute("SELECT TAM_POS_YARD FROM OPERADOR..TB_PATIOS WHERE AUTONUM=" & Col_Patio)(0)
            Col_Flag_Pilha_2040 = db.Execute("SELECT Flag_Pilha_2040 FROM OPERADOR..TB_PATIOS WHERE AUTONUM=" & Col_Patio)(0)
