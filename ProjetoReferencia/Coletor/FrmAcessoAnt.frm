...
Begin VB.Form Senha_E 
   ...
   Begin VB.PictureBox pQUADRO 
      ...
      Begin VB.ListBox List1 
         ...
         EndProperty
         Height          =   225
         ItemData        =   "FrmAcessoAnt.frx":210C
         Left            =   2835
         List            =   "FrmAcessoAnt.frx":210E
         TabIndex        =   3
         Top             =   1275
         Visible         =   0   'False
         Width           =   375
...
lRET = False
  ...
  ' MsgBox Sql
   ...
   If Not tbSenha.EOF Then
        ...
        Else
            Col_Patio = Nnull(tbSenha.Fields("PATIO"), 0)
            
            If Col_Patio = 7 Then Col_Patio = 1
            ...
            Wflag_carregamento_marcante_bip = Nnull(tbSenha!flag_carregamento_marcante_bip, 0)
